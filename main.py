...
def parse_args():
    ...
    parser.add_argument("--tasks", default=None, choices=MultiChoice(tasks.ALL_TASKS))#可以给定一个列表
    ...
    parser.add_argument("--write_out", action="store_true", default=False)#我希望是True
